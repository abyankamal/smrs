    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">Update Student Classes</h4>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('update.class') }}" method="post">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" type="text" name="class_name" value="{{$class->class_name}}" placeholder="Input Class Name" id="old-password-input">
                                <p class="font-style: italic">Eg: First, Second, Third, etc</p>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="old-password-input" class="col-sm-2 col-form-label">Section</label>
                            <div class="col-sm-10">
                                <input class="form-control" type="text" name="section" value="{{$class->section}}" placeholder="Input Secton" id="old-password-input">
                                <p class="font-style: italic">Eg: First, Second, Third, etc</p>
                            </div>
                        </div>
